...
const STEPS = [
  ...
  },
  {
    icon: Zap,
    badge: '⚡ 47 secondes',
    title: '6 agents IA travaillent pour vous',
    desc: 'Scout détecte, Analyst priorise, Executor répare, Vault prouve. Tout ça en moins de 47 secondes — sans équipe RSSI.',
    highlight: 'Cliquez "Lancer analyse 47s" pour le voir live',
