...
const agents = [
  ...
  },
  {
    id: "03",
    name: "Executor Agent",
    role: "Self-healing supervisé · Objectif < 4h",
    description: "Ferme les vulnérabilités via playbooks souverains, ou soumet au DSI pour validation Go/No-Go en 1 clic.",
    metric: "Objectif remédiation < 4h",
    Icon: Wrench,
    color: "text-success",
    glow: "hsl(158 80% 46%)",
    badge: "Self-Healing",
