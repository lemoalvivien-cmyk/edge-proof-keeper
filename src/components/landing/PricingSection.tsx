      ...
      <div className="container relative px-4">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            {/* Trial badge */}
            <div className="inline-flex items-center gap-2 mt-2 px-4 py-2 rounded-full bg-success/10 border border-success/30 text-success text-sm font-semibold">
          ...
          >
            <div className="min-w-[640px] rounded-xl border border-border glass-card p-4">
                      ...
                      {user ? (
                        plan.id === "enterprise" ? (
                          ...
                          >
                            ...
                            {plan.id === "starter" ? `Passer au Starter — ${plan.price}` : `Activer Pro — ${plan.price}`}
                            <ArrowRight className="w-4 h-4 ml-1" />
                          </Button>
                        )
                      ) : plan.id === "enterprise" ? (
                        ...
                        >
                          {checkoutLoading === plan.id
                            ? <Zap className="w-4 h-4 mr-1.5 animate-pulse" />
                            : <CreditCard className="w-4 h-4 mr-1.5" />}
                          Essayer 14 jours gratuit — {plan.price} / an
                          <ArrowRight className="w-4 h-4 ml-1" />
                        </Button>
                      )}
                      {plan.id !== "enterprise" && (
