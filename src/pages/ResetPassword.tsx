        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-xl">
          {!isRecovery ? (
            <div className="text-center py-4 text-muted-foreground text-sm">
              ...
              <button onClick={() => navigate('/auth')} className="text-primary hover:underline">Retour à la connexion</button>
            </div>
          ) : (
            <Form {...form}>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input type={showPass ? 'text' : 'password'} placeholder="Min. 6 caractères" className="pl-9 pr-10" {...field} />
                ...
                <FormField control={form.control} name="confirm" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                        <Input type={showPass ? 'text' : 'password'} placeholder="Répétez le mot de passe" className="pl-9" {...field} />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
